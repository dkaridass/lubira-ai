...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[9999] flex items-center justify-center bg-green-success text-white shadow-lg transition-all duration-300 hover:shadow-xl group"
      style={{
    ...
    >
      ...
      <span 
        className={`font-inter font-medium text-[15px] overflow-hidden whitespace-nowrap transition-all duration-300 ${
